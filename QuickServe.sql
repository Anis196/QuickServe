...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 13, 2024 at 08:49 AM
...
('admin', 'admin', 'Admin', 'Poorna', 'admin01@gmail.com', 'M', 'ADM', 4),
('anjibabu', '12344321', 'Anji', 'Babu', 'anjigoudtonta55@gmail.com', 'M', 'STD', 5),
('Rancho', '1234', 'Rancho', 'Tata', 'shop1@gmail.com', 'M', 'VEN', 6),
('userr', 'user1234', 'anis', 'Shaikh', 'shaikhanis2004@gmail.com', 'M', 'STD', 7);
...
(8, 1, 'Coffee', 15.00, '8_2.jpg'),
(9, 2, 'Veg Puff', 20.00, '9_3.jpg'),
(10, 1, 'Chicken Cheece Burger', 80.00, '10_3.jpg'),
...
(22, 1, 'Chicken Manchuria', 100.00, '22_3.png'),
(23, 1, 'Chicken Puff', 30.00, '23_3.png'),
(24, 1, 'Egg Puff', 25.00, '24_3.png'),
(25, 1, 'French Fries', 35.00, '25_3.png'),
(26, 1, 'Chicken Tikki Burger', 70.00, NULL),
(27, 1, 'Grilled Sandwitch', 40.00, NULL),
(29, 1, 'Kharbooja Juice', 40.00, '29_6.png'),
(30, 6, 'Banana Juice', 40.00, '30_6.png'),
(31, 2, 'Pineapple Juice', 40.00, '31_6.png'),
(32, 2, 'Grape Juice', 40.00, '32_6.png'),
(33, 2, 'Orange Juice', 40.00, '33_6.png'),
...
(72, 2, 1, 45, '2022-11-13 13:54:40', 'CNCL', '0000-00-00 00:00:00', ''),
(81, 3, 2, 57, '2022-11-14 13:42:35', 'FNSH', '2022-11-14 19:39:59', 'T75693953497569'),
(82, 1, 1, 58, '2022-11-15 02:17:22', 'VRFY', NULL, 'T75693953497569'),
(83, 1, 2, 59, '2022-11-15 02:19:16', 'FNSH', '2024-08-13 11:33:42', 'T75693953497569');
...
('Rancho', '1234', 'Cafeteria', 'Near Engg. Building', 'shop1@email.com', '7569395349', 'shop1.jpg', 1),
('Silencer', '1234', 'MBA Canteen', 'Near MBA and Pharmacy Building', 'mbacanteen@email.com', '7569395349', 'shop2.jpg', 2);
...
CREATE TABLE `vendor` (
  `v_username` text NOT NULL,
  `v_pwd` int(11) NOT NULL,
...
--
ALTER TABLE `cart`
  MODIFY `ct_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;
