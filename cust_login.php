...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin mt-auto">
        ...
        <form method="POST" action="check_login.php" class="form-floating">
            ...
            <a class="nav nav-item text-decoration-none text-muted mb-2 small" href="vendor/vendor_login.php">
                <i class="bi bi-shop me-2"></i>Log in to vendor account
            </a>
