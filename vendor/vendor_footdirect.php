...
<head>
    ...
    <title>About Us | QuickServe</title>
    <style>
       html,body {
  height:100%;
  min-height:100%;
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin text-center restricted mt-auto">
            ...
            <p class="mb-3 fw-normal text-bold text-wrap">ANIS SHAIKH</p>
            <a class="btn btn-danger btn-sm w-50" href="vendor_home.php">Return To Home</a>
    </div>
