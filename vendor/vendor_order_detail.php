...
<head>
    ...
    <title>Order Detail | QuickServe</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container px-5 py-4" id="cart-body">
        <div class="row my-4 border-bottom">
                    ...
                    <ul class="list-unstyled fw-light">
                        ...
                        <li class="list-item">From
                            <a class="text-decoration-none link-primary"
                                href="vendor_shop_detail.php?c_id=<?php echo $orh_arr['s_id']?>">
                                <?php
                        ...
                        <li class="list-item">Order of
                            <a class="text-decoration-none link-primary"
                                href="vendor_customer_detail.php?c_id=<?php echo $orh_arr['c_id']?>">
                                <?php
            ...
            <div class="row mb-3">
                <div class="col">
                <a class="btn btn-sm btn-primary mt-2 mt-md-0" href="vendor_order_update.php?orh_id=<?php echo $_GET["orh_id"]?>">
                        ...
                        <div class="col">
                            <ul class="list-group">
                                <a class="text-decoration-none"
                                    href="vendor_food_detail.php?f_id=<?php echo $ord_row["f_id"]?>">
                                    <li
