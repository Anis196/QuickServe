...
<head>
    ...
    <title>Order List | QuickServe</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container p-2 pb-0" id="vendor-dashboard">
        <div class="mt-4 border-bottom">
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-success text-white rounded text-start">
                    ...
                    <span class="me-2 float-end"><a class="text-decoration-none link-light" href="vendor_order_list.php">X</a></span>
                </div>
            </div>
            ...
            <form class="form-floating mb-3" method="GET" action="vendor_order_list.php">
                <div class="row g-2">
                    <div class="col">
                    ...
                    <div class="col-auto">
                        ...
                        <button type="reset" class="btn btn-danger"
                            onclick="javascript: window.location='vendor_order_list.php'">Clear</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <?php
        ...
        <div class="container align-items-stretch pt-2">
            ...
            <table class="table rounded-5 table-light table-striped table-hover align-middle caption-top mb-3">
                <caption><?php echo $numrow;?> order(s) <?php if(isset($_GET["search"])){?><br /><a
                        href="vendor_order_list.php" class="text-decoration-none text-danger">Clear Search
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="vendor_order_detail.php?orh_id=<?php echo $row["orh_id"]?>" class="btn btn-sm btn-primary">View</a>
                            <a href="vendor_order_update.php?orh_id=<?php echo $row["orh_id"]?>" class="btn btn-sm btn-outline-success">Update Status</a>
                            <a href="vendor_order_delete.php?orh_id=<?php echo $row["orh_id"]?>"
        ...
        <div class="row">
            <div class="col m-2 p-2 bg-danger text-white rounded text-start">
                ...
                <?php if(isset($_GET["search"])){ ?>
                <a href="vendor_order_list.php" class="text-white">Clear Search Result</a>
                <?php } ?>
            </div>
        </div>
        </div>
