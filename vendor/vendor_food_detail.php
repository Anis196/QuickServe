...
<head>
    ...
    <title>Food Detail | QuickServe</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container px-5 py-4" id="shop-body">
        ...
        <a class="btn btn-sm btn-primary mt-2 mt-md-0" href="vendor_food_edit.php?s_id=<?php echo $food_row["s_id"]?>&f_id=<?php echo $f_id?>">
            <i class="bi bi-pencil-square"></i>
            Update this menu
        </a>
        <a class="btn btn-sm btn-danger mt-2 mt-md-0" href="vendor_food_delete.php?f_id=<?php echo $f_id?>">
        ...
        <h3 class="border-top pt-3 mt-2">Orders</h3>
            <form class="form-floating mb-3" method="GET" action="vendor_food_detail.php">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-auto">
                        ...
                        <button type="reset" class="btn btn-danger"
                            onclick="javascript: window.location='vendor_food_detail.php?f_id=<?php echo $f_id?>'">Clear</button>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="container align-items-stretch">
            ...
            <table class="table rounded-5 table-light table-striped table-hover align-middle caption-top mb-3">
                <caption><?php echo $numrow;?> order(s) <?php if(isset($_GET["search"])){?><br /><a
                        href="vendor_food_detail.php?f_id=<?php echo $f_id?>" class="text-decoration-none text-danger">Clear Search
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="vendor_order_detail.php?orh_id=<?php echo $row["orh_id"]?>" class="btn btn-sm btn-primary">View</a></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
        ...
        <div class="row">
            <div class="col m-2 p-2 bg-danger text-white rounded text-start">
                ...
                <?php if(isset($_GET["search"])){ ?>
                <a href="vendor_food_detail.php?f_id=<?php echo $f_id;?>" class="text-white">Clear Search Result</a>
                <?php } ?>
            </div>
        </div>
