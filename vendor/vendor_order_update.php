...
<head>
    <?php 
        ...
        if(isset($_POST["upd_confirm"])){
            ...
            if($result){
                header("location: vendor_order_list.php?up_ods=1");
            }else{
                header("location: vendor_order_list.php?up_ods=0");
            }
            exit(1);
        }
        include('../head.php');
    ...
    <title>Update Order Status | QuickServe</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin mt-auto w-50">
        ...
        ?>
        <form method="POST" action="vendor_order_update.php" class="form-floating">
