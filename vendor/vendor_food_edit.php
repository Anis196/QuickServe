...
<head>
    <?php 
        ...
        if(isset($_POST["upd_confirm"])){
            ...
            if($update_result){header("location: vendor_food_detail.php?f_id={$f_id}&up_fdt=1");}
            else{header("location: vendor_food_detail.php?f_id={$f_id}&up_fdt=0");}
            exit(1);
        }
        include('../head.php');
    ?>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin mt-auto w-50">
        ...
        ?>
        <form method="POST" action="vendor_food_edit.php" class="form-floating" enctype="multipart/form-data">
